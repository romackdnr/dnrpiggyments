                  ...
                  <td style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#0000; margin-top:10px;" colspan="4"><span class="style7"><strong>Shipping Method</strong> </span><br />
					...
					?>
                      ...
                      <tr bgcolor="#CCCCCC">
                        ...
                        <td width="255" align="left" class="body_text">Next Day Air Early AM</td>
					...
					?>
                      ...
                      <tr bgcolor="#CCCCCC">
                        ...
                        <td align="left" class="body_text">Next Day Air </td>
					...
					?>
                      ...
                      <tr bgcolor="#CCCCCC">
                        ...
                        <td align="left" class="body_text">Next Day Air Saver </td>
                        <td class="body_text"><?php
						    echo '$'. number_format($quote,2);
						  ?>                        </td>
                      </tr>
					...
					?>
                      ...
                      <tr bgcolor="#CCCCCC">
                        ...
                        <td align="left" class="body_text">2nd Day Air Early AM</td>
                        <td class="body_text"><?php
						    echo '$'. number_format($quote,2);
						  ?>                        </td>
                      </tr>
					...
					?>
                      ...
                      <tr bgcolor="#CCCCCC">
                        ...
                        <td align="left" class="body_text">2nd Day Air</td>
					...
					?>
                      ...
                      <tr bgcolor="#CCCCCC">
                        ...
                        <td align="left" class="body_text">3 Day Select </td>
                        <td class="body_text"><?php echo '$' . number_format($quote,2);?></td>
                      </tr>
                      <?php } ?>
                      <?php
					...
					?>
                      ...
                      <tr bgcolor="#CCCCCC">
                        ...
                        <td align="left" class="body_text">Ground </td>
                        <td class="body_text"><?php echo '$' . number_format($quote,2); ?></td>
                      </tr>
                      <?php } ?>
                      <?php
					...
					?>
                      ...
                      <tr bgcolor="#CCCCCC">
                        ...
                        <td align="left" class="body_text">Canada Standard</td>
                        <td class="body_text"><?php echo '$' . number_format($quote,2); ?></td>
                      </tr>
                      <?php } ?>
                      <?php
					...
					?>
                      ...
                      <tr bgcolor="#CCCCCC">
                        ...
                        <td align="left" class="body_text">Worldwide Express</td>
                        <td class="body_text"><?php echo '$' . number_format($quote,2); ?></td>
                      </tr>
                      <?php } ?>
                      <?php
					...
					?>
                      ...
                      <tr bgcolor="#CCCCCC">
                        ...
                        <td align="left" class="body_text">Worldwide Express Plus</td>
                        <td class="body_text"><?php echo '$' . number_format($quote,2); ?></td>
                      </tr>
                      <?php } ?>
                      <?php
					...
					?>
                      ...
                      <tr bgcolor="#CCCCCC">
                        ...
                        <td align="left" class="body_text">Worldwide Expedited </td>
                        <td class="body_text"><?php echo '$' . number_format($quote,2); ?></td>
                      </tr>
                      <?php } ?>
