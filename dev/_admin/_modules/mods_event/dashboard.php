...
<body onLoad="javascript:alternatecolor('alter_rows');">
	...
	<div id="blog_overview">
    	<ul class="btn">
	  		<li><a href="<?=$ROOT_URL?>_admin/modules_news/add/">Add New Post</a></li>
        </ul>
        ...
        <?php
			...
			?>
                    ...
                    <tr>
                      ...
                      <td><?=$newss->fldNewsTitle?></td>
                     
                      <td align="center"><a href="<?=$ROOT_URL?>_admin/modules_news/edit/<?=$newss->fldNewsID?>/"><img src="<?=$ROOT_URL?>_admin/_modules/mods_blog/images/modify.png" width="14" height="16" alt="mod" /></a> <a href="<?=$ROOT_URL?>_admin/modules_news/delete/<?=$newss->fldNewsID?>/" title="Delete Page" onClick="return confirm(&quot;Are you sure you want to completely remove this News from the database?\n\nPress 'OK' to delete.\nPress 'Cancel' to go back without deleting the News.\n&quot;)"><img src="<?=$ROOT_URL?>_admin/_modules/mods_blog/images/delete.gif" width="16" height="16" alt="del" /></a> </td>
                    </tr>
        <? } }?>
