...
if(isset($_REQUEST['delete'])) {
	ProductsOption::deleteProductsOptionByOptions($_REQUEST['delete']);
       ...
       <?php
			...
			?>		
                <tr>
                  ...
                  <td align="center"><a href="<?=$ROOT_URL?>_admin/modules_products_options/edit/<?=$products->fldProductsOptionID?>/<?=$_REQUEST['id']?>/"><img src="<?=$ROOT_URL?>_admin/_modules/mods_store/images/modify.png" width="14" height="16" alt="mod" /></a> <a href="<?=$ROOT_URL?>_admin/modules_products_options/delete/<?=$products->fldProductsOptionID?>/<?=$_REQUEST['id']?>/" title="Delete Page" onClick="return confirm(&quot;Are you sure you want to completely remove this Products Options from the database?\n\nPress 'OK' to delete.\nPress 'Cancel' to go back without deleting the Products Options.\n&quot;)"><img src="<?=$ROOT_URL?>_admin/_modules/mods_store/images/delete.gif" width="16" height="16" alt="del" /></a> 
