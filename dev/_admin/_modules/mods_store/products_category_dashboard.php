       ...
       <?php
			...
			?>		
                <tr>
                  ...
                  <td align="center"><a href="<?=$ROOT_URL?>_admin/modules_products/view/<?=$categories->fldCategoryID?>/"> [ View Products ] </a> </td>
                </tr>
                    	...
                    	<td colspan="3" style="padding-left:200px;">
                            ...
                            ?>
                                  <tr>
                                      ...
                                      <td align="center"><a href="<?=$ROOT_URL?>_admin/modules_products/view/<?=$subCats->fldCategoryID?>/"> [ View Products ] </a> </td>
                                    </tr>       
                            <? } //foreach subcat?>	
                         </tbody>
                         </table>   	
