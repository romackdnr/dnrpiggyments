...
if(isset($_REQUEST['delete'])) {
	Contact::deleteContact($_REQUEST['delete']);
	
	$updates = 'Delete contacts content';
...
<body onLoad="javascript:alternatecolor('alter_rows');">
	...
	<div id="blog_overview">
    	<ul class="btn">
	  		<li><a href="<?=$ROOT_URL?>_admin/modules_contact/add/">Add New Contact</a></li>
        </ul>
    ...
    <table id="page_manager">
      ...
      <tbody id="alter_rows">
        <?php
				 $count_record=Contact::countContact();
			...
			?>
                    ...
                    <tr>
                      ...
                      <td><?=$contacts->fldContactName?></td>
                       <td><?=$contacts->fldContactEmail?></td>
                      <td align="center"><a href="<?=$ROOT_URL?>_admin/modules_contact/edit/<?=$contacts->fldContactID?>/"><img src="<?=$ROOT_URL?>_admin/_modules/mods_contact/images/modify.png" width="14" height="16" alt="mod" /></a> <a href="<?=$ROOT_URL?>_admin/modules_contact/delete/<?=$contacts->fldContactID?>/" title="Delete Page" onClick="return confirm(&quot;Are you sure you want to completely remove this Contacts from the database?\n\nPress 'OK' to delete.\nPress 'Cancel' to go back without deleting the Contacts.\n&quot;)"><img src="<?=$ROOT_URL?>_admin/_modules/mods_contact/images/delete.gif" width="16" height="16" alt="del" /></a> </td>
                    </tr>
        <? } }?>
