...
if(isset($_REQUEST['delete'])) {
	Coupon::deleteCoupon($_REQUEST['delete']);
	
	$updates = 'Delete coupons content';
...
<body onLoad="javascript:alternatecolor('alter_rows');">
	...
	<div id="blog_overview">
    	<ul class="btn">
	  		<li><a href="<?=$ROOT_URL?>_admin/modules_coupon/add/">Add New Coupon</a></li>
        </ul>
    ...
    <table id="page_manager">
      ...
      <tbody id="alter_rows">
        <?php
				 $count_record=Coupon::countCoupon();
			...
			?>
                    ...
                    <tr>
                       <td> <?=$coupons->fldCouponID?> </td>
                      <td> <?=$coupons->fldCouponCode?> </td>
                      <td><?=$coupons->fldCouponName?></td>
                      
                      <td align="center"><a href="<?=$ROOT_URL?>_admin/modules_coupon/edit/<?=$coupons->fldCouponID?>/"><img src="<?=$ROOT_URL?>_admin/_modules/mods_coupon/images/modify.png" width="14" height="16" alt="mod" /></a> <a href="<?=$ROOT_URL?>_admin/modules_coupon/delete/<?=$coupons->fldCouponID?>/" title="Delete Page" onClick="return confirm(&quot;Are you sure you want to completely remove this Coupons from the database?\n\nPress 'OK' to delete.\nPress 'Cancel' to go back without deleting the v.\n&quot;)"><img src="<?=$ROOT_URL?>_admin/_modules/mods_coupon/images/delete.gif" width="16" height="16" alt="del" /></a> </td>
                    </tr>
        <? } }?>
