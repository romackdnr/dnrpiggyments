...
<body onLoad="javascript:alternatecolor('alter_rows');">
	...
	<div id="blog_overview">
    	<ul class="btn">
	  		<li><a href="<?=$ROOT_URL?>_admin/modules_client/add/">Add New Client</a></li>
        </ul>
        ...
        <?php
			...
			?>
                    ...
                    <tr>
                      ...
                      <td align="center"><a href="<?=$ROOT_URL?>_admin/modules_client/edit/<?=$clients->fldClientID?>/"><img src="<?=$ROOT_URL?>_admin/_modules/mods_client/images/modify.png" width="14" height="16" alt="mod" /></a> <a href="<?=$ROOT_URL?>_admin/modules_client/delete/<?=$clients->fldClientID?>/" title="Delete Page" onClick="return confirm(&quot;Are you sure you want to completely remove this Clients from the database?\n\nPress 'OK' to delete.\nPress 'Cancel' to go back without deleting the Clients.\n&quot;)"><img src="<?=$ROOT_URL?>_admin/_modules/mods_client/images/delete.gif" width="16" height="16" alt="del" /></a> </td>
                    </tr>
        <? } }?>
