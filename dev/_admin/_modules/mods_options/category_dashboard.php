...
if(isset($_REQUEST['delete'])) {
	OptionsCategory::deleteOptionsCategory($_REQUEST['delete']);
	
		 $updates = 'Delete options category content';
...
<body onLoad="javascript:alternatecolor('alter_rows');">
	...
	<div id="store_overview">
    	<ul class="btn">
  			<li><a href="<?=$ROOT_URL?>_admin/modules_category_options/add/">Add New Item</a></li>    		
    	</ul>
    ...
    <table id="page_manager">
      ...
      <thead>
        <tr class="headers">
          <td width="30"> ID </td>
          <td width="100">Options Category Name</td>          
      ...
      <tbody id="alter_rows">
       <?php
			...
			?>		
                <tr>
                  <td> <?=$categories->fldOptionsCategoryID?> </td>
                  
                  <td><?=$categories->fldOptionsCategoryName?></td>                  
                  <td align="center"><a href="<?=$ROOT_URL?>_admin/modules_category_options/edit/<?=$categories->fldOptionsCategoryID?>/"><img src="<?=$ROOT_URL?>_admin/_modules/mods_store/images/modify.png" width="14" height="16" alt="mod" /></a> <a href="<?=$ROOT_URL?>_admin/modules_category/delete/<?=$categories->fldOptionsCategoryID?>/" title="Delete Option Category" onClick="return confirm(&quot;Are you sure you want to completely remove this Options Category from the database?\n\nPress 'OK' to delete.\nPress 'Cancel' to go back without deleting the options Category.\n&quot;)"><img src="<?=$ROOT_URL?>_admin/_modules/mods_store/images/delete.gif" width="16" height="16" alt="del" /></a> 
                  <a href="<?=$ROOT_URL?>_admin/modules_options/view/<?=$categories->fldOptionsCategoryID?>/"> [ View Options ] </a>
                  </td>
                </tr>
