...
<body onLoad="javascript:alternatecolor('alter_rows');">
	...
	<div id="store_overview">
    	<ul class="btn">
  			<li><a href="<?=$ROOT_URL?>_admin/modules_specials/add/">Add New Item</a></li>
    		
    	</ul>
    <h3>Special Products Overview</h3>
       ...
       <?php
			...
			?>		
                <tr>
                  ...
                  <td align="center"><a href="<?=$ROOT_URL?>_admin/modules_specials/edit/<?=$products->fldProductsId?>/"><img src="<?=$ROOT_URL?>_admin/_modules/mods_store/images/modify.png" width="14" height="16" alt="mod" /></a> <a href="<?=$ROOT_URL?>_admin/modules_specials/delete/<?=$products->fldProductsId?>/" title="Delete Page" onClick="return confirm(&quot;Are you sure you want to completely remove this Specials from the database?\n\nPress 'OK' to delete.\nPress 'Cancel' to go back without deleting the Specials.\n&quot;)"><img src="<?=$ROOT_URL?>_admin/_modules/mods_store/images/delete.gif" width="16" height="16" alt="del" /></a> </td>
                </tr>
        <? } } ?>
