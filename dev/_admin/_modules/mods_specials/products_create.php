...
// $my_upload->extensions = "de"; // use this to switch the messages into an other language (translate first!!!)
	...
	$isRecommend=0;
	 $_POST = sanitize($_POST);
	  ...
	  $products->isRecommend=$isRecommend;
	  Products::addProducts($products,$full_path); 
    ...
    <fieldset style="width:1065px;">
      ...
      <ul>
        ...
        <li>
          ...
          $<input type="text" id="title" name="price_value">
        </li>
        <li>
        ...
        <li>
         ...
         <li>
          ...
          <textarea cols="" rows="" id="benefits" name="benefits"></textarea>
        </li>
        <li>
          <label for="howto">How to Use</label>
          <textarea cols="" rows="" id="howto" name="howto"></textarea>
        </li>
         <li>
          <label for="ingredients">Ingredients</label>
          <textarea cols="" rows="" id="ingredients" name="ingredients"></textarea>
        </li>
        <li>
          <label for="use">Use With</label>
          <textarea cols="" rows="" id="use" name="usewith"></textarea>
        </li>
      </ul>
