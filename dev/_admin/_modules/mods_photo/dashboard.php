...
if(isset($_REQUEST['delete'])) {
	PhotoGallery::deletePhotoGallery($_REQUEST['delete']);
	
		$updates = 'Delete photo gallery content';
...
<head>
  ...
  <link rel="stylesheet" type="text/css" media="screen" href="<?=$ROOT_URL?>_admin/_modules/mods_photo/css/photoswitcher.css" />
	<script type="text/javascript" src="<?=$ROOT_URL?>_admin/_assets/js/jquery.js"></script>
  <script type="text/javascript" src="<?=$ROOT_URL?>_admin/_modules/mods_photo/js/photoswitcher.js"></script>
</head>
...
<body>
	...
	<div id="photo_overview">
    	<ul class="btn">
			<li><a href="<?=$ROOT_URL?>_admin/photo_upload/">Upload New Photo</a></li>
        </ul>    
			...
			?>
                  <li>
                    <div class="content_block"> <a href="#"><img src="<?=$ROOT_URL?><?=$image?>" width="215"  alt=""></a>
                      <h3><a href="#"><?=$photos->fldPhotoGalleryName?></a></h3>
                      <p>Category: <?=$photos->fldPhotoGalleryCategory?></p>
                      <p><?=$photos->fldPhotoGalleryDescription?></p>
                      <p><a href="<?=$ROOT_URL?>_admin/photo_edit/<?=$photos->fldPhotoGalleryID?>/<?=$photos->fldPhotoGalleryName?>/">Edit</a> | 
                      <a href="<?=$ROOT_URL?>_admin/photo_delete/<?=$photos->fldPhotoGalleryID?>/<?=$photos->fldPhotoGalleryName?>/" onClick="return confirm(&quot;Are you sure you want to completely remove this Photos from the database?\n\nPress 'OK' to delete.\nPress 'Cancel' to go back without deleting the Photos.\n&quot;)">Delete</a></p>
                    </div>
                  </li>
		      <? } // foreach?>
          <? } //if ?>    
