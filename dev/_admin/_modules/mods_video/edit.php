    ...
    <fieldset style="width:1065px;">
      ...
      <ul>
        <li>
          ...
          <input type="text" id="title" name="name" value="<?=$videos->fldVideoGalleryName?>">
        </li>
        <li>
          <label for="category">Video Category</label>
          <input type="text" id="category" name="category" value="<?=$videos->fldVideoGalleryCategory?>">
        </li>
        <li>
        ...
        <li style="margin-top:50px;">
          ...
          <textarea cols="" rows="" id="video.editor" name="description"><?=$videos->fldVideoGalleryDescription?> </textarea>
        </li>
      </ul>
      ...
      <fieldset id="preview">
		...
		?>
        <div class="previewbox"><img src="<?=$ROOT_URL?><?=$image?>" width="150"  alt=""></div>        
      </fieldset>      
    </fieldset>
    <ul class="submission">
    <input type="hidden" name="Id" value="<?=$videos->fldVideoGalleryID?>">
