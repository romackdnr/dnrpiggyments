...
*/
$IMConfig['base_dir'] = $_SERVER['DOCUMENT_ROOT'] . '/_mark/html/dnr/_acm/_filemanager/Image';
...
*/
$IMConfig['base_url'] = 'http://' . $_SERVER['SERVER_NAME']  . '/_mark/html/dnr/_acm/_filemanager/Image';
