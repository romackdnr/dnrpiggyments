...
(function($) {
    ...
    $.fn.activebar = function( options ) {
        ...
        if(options.preload){
          ...
          $('<img src="../../assets/ie6update/'+options.icons_path+'icon.png" class="normal">').load(function(){load.a=1; preloadInit()});
          $('<img src="../../assets/ie6update/'+options.icons_path+'icon-over.png" class="normal">').load(function(){load.b=1; preloadInit()});
          $('<img src="../../assets/ie6update/'+options.icons_path+'close.png" class="normal">').load(function(){load.c=1; preloadInit()});
          $('<img src="../../assets/ie6update/'+options.icons_path+'close-over.png" class="normal">').load(function(){load.d=1; preloadInit()});
     ...
     ****************************************************************/
     ...
     function initializeActivebar( options ) {
        ...
        container.append( 
          ...
          .append('<img src="../../assets/ie6update/'+options.icons_path+'icon.png" class="normal">')
          .append('<img src="../../assets/ie6update/'+options.icons_path+'icon-over.png" class="hover">')
        );
        ...
        container.append( 
          ...
          .append('<img src="../../assets/ie6update/'+options.icons_path+'close.png" class="normal">')
          .append('<img src="../../assets/ie6update/'+options.icons_path+'close-over.png" class="hover">')
        );
...
jQuery(document).ready(function($) {
  $('<div></div>').html(IE6UPDATE_OPTIONS.message || 'Internet Explorer is missing updates required to view this site. Please click here to update... ')
