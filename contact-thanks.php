...
<div id="wrapper">
    ...
    <div id="menu">
	  <?php require_once('header.php'); ?></div>
        ...
        <p class="TitulosSecciones">Thank you for visiting <strong>Piggyments Marketing, Inc.</strong>.<br />Someone will be contacting you shortly.
<?
